...
const AnimationMovies = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://api.themoviedb.org/3/discover/movie?with_genres=16&include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc', options)
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <h2 className="text-2xl font-bold text-center mb-6">Cizgi Film Filmleri</h2>
