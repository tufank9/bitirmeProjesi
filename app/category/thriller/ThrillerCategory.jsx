...
const ThrillerMovies = () => {
  ...
  useEffect(() => {
    ...
    // Gerilim filmleri için API çağrısı
    fetch('https://api.themoviedb.org/3/discover/movie?with_genres=53&include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc', options)
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <h2 className="text-2xl font-bold text-center mb-6">Gerilim Filmleri</h2>
