...
const SciFiMovies = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://api.themoviedb.org/3/discover/movie?with_genres=878&include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc', options)
      ...
      .then(data => {
        const movies = data.results.slice(0, 25).map(movie => ({
          ...
          poster: movie.poster_path ? `https://image.tmdb.org/t/p/w500${movie.poster_path}` : '/placeholder.svg' // Poster görseli ya da placeholder
        }));
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <h2 className="text-2xl font-bold text-center mb-6">Bilim Kurgu Filmleri</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 justify-center"> {/* Grid yapısı */}
